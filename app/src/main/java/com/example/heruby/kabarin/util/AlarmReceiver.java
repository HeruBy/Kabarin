package com.example.heruby.kabarin.util;
...
/**
 * Created by Andri Ginting on 12/12/2017.
 */
...
public class AlarmReceiver extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String judul = type.equalsIgnoreCase(TYPE_ONE_TIME) ? " Sekali Bunyi" :"Berulang kali" ;
        int notifId = type.equalsIgnoreCase(TYPE_ONE_TIME) ? NOTIF_ID_ONETIME : NOTIF_ID_REPEATING;

        showAlarmNotification(context,judul,pesan,notifId);
    }

    private void showAlarmNotification(Context context,String judul, String pesan, int notifId){
    ...
    public void setOneTimeAlarm(Context context, String type, String date, String time, String pesan){
    ...
    public void setRepeatingAlarm(Context context, String type, String time, String pesan){
        AlarmManager alarmManager = (AlarmManager)context.getSystemService(Context.ALARM_SERVICE);
        Intent intent = new Intent(context, AlarmReceiver.class);
        intent.putExtra(EXTRA_MESSAGE, pesan);
        intent.putExtra(EXTRA_TYPE, type);
